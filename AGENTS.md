...
This repository is an interactive long-form fiction workbench. Users should be able to clone it, open it in an Agent-capable coding environment, and work through natural-language requests without installing the root Skill elsewhere.
...
- **A chapter, continuation, or revision is requested**: use the active project's generated writer Skill and Mode C. Load the locked style contract and durable memory before drafting.
...
- Never update canon from an unaccepted draft.
